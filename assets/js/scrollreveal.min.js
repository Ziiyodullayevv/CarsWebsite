...
var ScrollReveal = (function () {
  ...
  var n = {
    success: function () {
      document.documentElement.classList.add ('sr'), document.body
  ...
  function u (e, t) {
    ...
    if (o (e)) return [e];
    if (
      ((n = e), (i = Object.prototype.toString.call (n)), 'object' ==
        typeof window.NodeList
  ...
  function t () {
    ...
    f (this.store.elements, function (e) {
      ...
      t.removeEventListener (
        'scroll',
        n.delegate
      ), t.removeEventListener ('resize', n.delegate), delete n.store.containers[e];
  ...
  function N (e) {
    ...
    var t = z ();
    return (t[0] = e[0]), (t[1] = e[1]), (t[4] = e[2]), (t[5] = e[3]), (t[12] =
      e[4]), (t[13] = e[5]), t;
  }
  function z () {
  ...
  function p (e) {
    ...
    i.rotate.x &&
      j.push (
        ((d = i.rotate.x), (u =
          Math.PI / 180 * d), ((f = z ())[5] = f[10] = Math.cos (
          u
        )), (f[6] = f[9] = Math.sin (u)), (f[9] *= -1), f)
      ), i.rotate.y &&
      j.push (
        ((h = i.rotate.y), (p =
          Math.PI / 180 * h), ((m = z ())[0] = m[10] = Math.cos (
          p
        )), (m[2] = m[8] = Math.sin (p)), (m[2] *= -1), m)
      ), i.rotate.z &&
      j.push (
        ((y = i.rotate.z), (v =
          Math.PI / 180 * y), ((g = z ())[0] = g[5] = Math.cos (
          v
        )), (g[1] = g[4] = Math.sin (v)), (g[4] *= -1), g)
      ), 1 !== i.scale &&
    ...
    if (E.generated || R.generated.initial) {
      (A.property = S ('transition')), (A.computed =
        t[A.property]), (A.fragments = []);
      ...
      var I = A.fragments.reduce (
        function (e, t, n) {
          return (e.delayed += 0 === n
            ? t.delayed
            : ', ' + t.delayed), (e.instant += 0 === n
            ? t.instant
            : ', ' + t.instant), e;
        },
        {delayed: '', instant: ''}
    ...
    try {
      f (u (e), function (e) {
        ...
        if (null !== t) {
          ...
          n.callbackTimer && window.clearTimeout (n.callbackTimer.clock), m (
            n.node,
            n.styles.inline.generated
  ...
  function g (e) {
    return void 0 === e &&
      (e = navigator.userAgent), /Android|iPhone|iPad|iPod/i.test (e);
  }
  var e,
    b = ((e = 0), function () {
      return e++;
  ...
  function w () {
    ...
    t.call (this), f (this.store.elements, function (e) {
      ...
      e.visible
        ? (t.push (e.styles.opacity.computed), t.push (
            e.styles.transform.generated.final
          ), (e.revealed = !0))
        : (t.push (e.styles.opacity.generated), t.push (
  ...
  function a (e, t) {
    var n = this,
      ...
      s = 0;
    e.callbackTimer &&
      ((s = Date.now () - e.callbackTimer.start), window.clearTimeout (
        e.callbackTimer.clock
      )), r (e.node), (e.callbackTimer = {
      start: Date.now (),
      clock: window.setTimeout (function () {
        o (
          e.node
        ), (e.callbackTimer = null), e.revealed && !e.config.reset && e.config.cleanup && y.call (n, e.node);
      }, i - s),
    });
  }
  function l (e, t) {
    if (
      (void 0 === t && (t = this.pristine), !e.visible &&
        e.revealed &&
        e.config.reset)
    )
    ...
    if (n) {
      ...
      if (((n.models = {visible: r, revealed: o}), !o.body.length)) {
        ...
        if (a)
          return j.call (this, n, r.body[0], -1, t), j.call (
            this,
            n,
            r.body[0],
            1,
      ...
      if (
        ...
        return j.call (this, n, i, -1, t), c.call (this, e, {
          reveal: !0,
          pristine: t,
        });
      if (
  ...
  function E (e) {
    ...
    (this.id = b ()), (this.interval = Math.max (
      t,
      16
    )), (this.members = []), (this.models = {}), (this.blocked = {
      head: !1,
      foot: !1,
    });
  }
  function d (e, i, r) {
    var o = this;
    (this.head = []), (this.body = []), (this.foot = []), f (
      e.members,
      function (e, t) {
        var n = r.elements[e];
        n && n[i] && o.body.push (t);
  ...
  function i (e, a, t) {
          ...
          return s.contains (t) &&
            (null ===
              ...
              ((o = b ()), d.push ({
                id: o,
                node: s,
              })), (n.config = r), (n.containerId = o), (n.styles = p (n)), l &&
              ((n.sequence = {
                id: l.id,
    ...
    f (d, function (e) {
      ...
      (this.store.history.push ({target: e, options: a}), this.initTimeout &&
        window.clearTimeout (
          this.initTimeout
  ...
  function R (e, t) {
    for (
      var n = t ? e.node.clientHeight : e.node.offsetHeight,
        ...
        o = 0,
        s = e.node;
      isNaN (s.offsetTop) || (r += s.offsetTop), isNaN (s.offsetLeft) ||
        (o += s.offsetLeft), (s = s.offsetParent);
  ...
  function q (e, t) {
    var i = this;
    void 0 === e && (e = {type: 'init'}), void 0 === t &&
      (t = this.store.elements), x (function () {
      var n = 'init' === e.type || 'resize' === e.type;
      f (i.store.containers, function (e) {
        n && (e.geometry = R.call (i, e, !0));
        var t = function (e) {
          var t, n;
          return (n = e.node === document.documentElement
        ...
        (n || void 0 === e.geometry) &&
          (e.geometry = R.call (i, e)), (e.visible = function (e) {
          void 0 === e && (e = {});
  ...
  function H (e) {
    ...
    if (
      (void 0 === e && (e = {}), void 0 === this ||
        Object.getPrototypeOf (this) !== H.prototype)
    )
      return new H (e);
    if (!H.isSupported ())
      return h.call (
    ...
    return (!(C = t).mobile && g ()) || (!C.desktop && !g ())
      ...
      : (n.success (), (this.store = {
          containers: {},
          elements: {},
          history: [],
          sequences: {},
        }), (this.pristine = !0), (A = A || q.bind (this)), (P =
          P ||
          function () {
            var n = this;
            f (this.store.elements, function (e) {
